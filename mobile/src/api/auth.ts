...
export const authApi = {
  ...
  signup: (payload: { email: string; password: string; fullName: string; phone: string; subscribedEmail?: boolean }) => apiRequest<CustomerSession>('/auth/signup', { method: 'POST', body: JSON.stringify(payload) }),
