...
export function SignupScreen({ navigation }: any) {
  ...
  return <Screen>
    ...
    <View style={sectionCard}>
      ...
      <TextInput placeholder="Votre nom" value={fullName} onChangeText={setFullName} style={inputStyle} placeholderTextColor="#8b837b" />
      <Text style={fieldLabel}>Téléphone</Text>
      <TextInput placeholder="Votre numéro" value={phone} onChangeText={setPhone} style={inputStyle} placeholderTextColor="#8b837b" keyboardType="phone-pad" />
      ...
      <TextInput placeholder="Choisissez un mot de passe" secureTextEntry value={password} onChangeText={setPassword} style={inputStyle} placeholderTextColor="#8b837b" />
